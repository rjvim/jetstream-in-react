...
const ApiTokenManager: React.FC<ApiTokenManagerProps> = ({
    ...
    const updateApiToken: FormEventHandler = (e) => {
        ...
        updateApiTokenForm.put(
            route('api-tokens.update', managingPermissionsFor?.id),
            {
                preserveScroll: true,
                preserveState: true,
    ...
    const deleteApiToken: FormEventHandler = (e) => {
        ...
        deleteApiTokenForm.delete(
            route('api-tokens.destroy', apiTokenBeingDeleted?.id),
            {
                preserveScroll: true,
                preserveState: true,
                                    ...
                                    {tokens.map((token) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center ms-2">
                                                ...
                                                <button
                                                    className="text-sm text-red-500 cursor-pointer ms-6"
                                                    onClick={() =>
